    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            if index == 0:
                ...
                # added a feature to update the coordinates of the heads rect
                self.head_rect = self.head.get_rect(topleft=(x_pos, y_pos))
...
class FRUIT:
    def __init__(self, a, b):
        ...
        self.spawn = [
            ...
            Vector2(50, 215), Vector2(400, 215), Vector2(1000, 215), Vector2(1200, 215), Vector2(1400, 215),
            Vector2(1500, 215),
...
class Main:
    ...
    def get_random_product(self):
        arr = []
        for i in range(8):
            x = random.randint(5, self.a-1)
            y = random.randint(5, self.b-1)
            arr.append(x)
            arr.append(y)
        return arr
